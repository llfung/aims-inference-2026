...
- [Course contents](https://github.com/jonathon-langford/aims-inference-2026/tree/main/1_simulation_based_inference)
...
## Project assessment
The project will be assessed based on the criteria in the [marking rubric](aims-week3-rubric.pdf). There are six categories, each worth 1-5 marks (30 total):
...
We have provided a set of template slides for the presentation. These slides can be found in the following [google slides link](https://docs.google.com/presentation/d/1cMf6OXDTdCTQcCY-vlpTPCBhjOO-EnIpCB-gizIKang/edit?usp=sharing). Please make a copy to start editing. Each student is expected to present at least one slide for an expected length of 2-3 minutes. After the presentation, we will ask one question to each student in the group.
